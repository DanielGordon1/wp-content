...
class CSFramework extends CSFramework_Abstract {
  ...
  public function admin_menu() {
    ...
    if( $args['menu_type'] == 'add_' . 'submenu' . '_page' ) {
  ...
  public function admin_page() {
    ...
    echo '<div class="cs-framework cs-option-framework">';
      ...
      echo '<fieldset>';
      echo ( $this->settings['ajax_save'] === true ) ? '<span id="cs-save-ajax">'. esc_html__( 'Settings saved.', 'cs-framework' ) .'</span>' : '';
      submit_button( esc_html__( 'Save', 'cs-framework' ), 'primary', 'save', false, array( 'data-ajax' => $this->settings['ajax_save'], 'data-save' => esc_html__( 'Saving...', 'cs-framework' ) ) );
